$(function(){
  ...
  $('#image-box_new').on('change', '.js-file', function(e) {
  ...
  $('#image-box_new').on('click', '.js-remove', function() {
    ...
    if ((targetIndex == limitFileField ) || ($(".js-file_group").length >= 9)) ($('#image-box_new').append(buildFileField(fileIndex)));
  });
});
