class Item < ApplicationRecord
  ...
  enum category:  [:レディース, :メンズ, :ベビー・キッズ, :インテリア・住まい。小物, :本・音楽・ゲーム, :おもちゃ・ホビー・グッズ, :コスメ・香水・美容, :家電・スマホ・カメラ, :スポーツ・レジャー, :ハンドメイド, :チケット, :自転車・オートバイ, :その他]
  enum size:      [:SS, :S, :M, :L, :LL, :LX]
  enum condition: [:新品・未使用, :未使用に近い, :目立った傷や汚れなし, :やや傷や汚れあり, :全体的に状態が悪い]
  ...
  enum deliberydate: [:"1~2日で発送", :"3~4日で発送", :"4~7日で発送"]
end